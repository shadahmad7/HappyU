...
const addVideo = () => {
  ...
  const onDelete = async (id) => {
    ...
    await fetch('deleteWorkoutVideo', requestOptions)
  ...
  const submit = async () => {
    ...
    if(a === false ){
      ...
      await fetch('addWorkoutVideo', requestOptions)
        .then((response) => response.json())
        .then((result) => console.log(result))
        .catch((error) => console.log('error', error))
                    ...
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell>
                        <div className="small text-medium-emphasis">
                          <a target="_blank" href={baseUrl + item.workout_video_url}>
                            https://www.youtube.com/watch?v={item.workout_video_url}
                          </a>
                        </div>
                      </CTableDataCell>
                      <CTableDataCell>
                        <div className="small text-medium-emphasis">
                          {item.workout_video_duration}
                        </div>
                      </CTableDataCell>
                      <CTableDataCell>
                        <div className="trash" onClick={() => onDelete(item.workout_video_id)}>
