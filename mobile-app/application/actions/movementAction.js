...
export const putMovementStatus = async (status) => {
  let resUserData,uid;
...
export const getMovementData = async () => {
  let resUserData;
  const workoutResponse = await fetch(api.url + `getMovementArticles`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
