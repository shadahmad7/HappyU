...
class Journal extends Component {
  ...
  async submitOkay() {
    ...
    AsyncStore.storeData(`@journal`, JSON.stringify(data));
    AsyncStore.getData(`@journal`).then((adata) => {
      console.log("NNNNNNNNNNN", adata);
    });
    await this.props.navigation.navigate("Journalising", {
      days: selectedDays,
    });
  }
          ...
          <View style={styles.container}>
            <ScrollView>
              <LottieView
                ...
                source={require("../../../assets/animated/journal2.json")}
              />
              ...
              <View style={{ marginTop: 27, justifyContent: "center" }}>
                ...
                >
                  Which days do you want to journal?
                </Text>
              </View>
...
fontFamily:'GothamLight',
              ...
              >
                {this.state.selectedDays.length === 0 && (
                  <Text style={{ color: "#fff",fontFamily:"GothamLight" }}>
                  ...
                  <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                      <View style={{ padding: 15, }}>
                        ...
                        >
                          Great! We will remind you on the particular days you
                          have chosen to journal. Stay healthy!
                        </Text>
                      </View>
                      <TouchableOpacity
                        style={{
...
export default withNavigationFocus(Journal);
